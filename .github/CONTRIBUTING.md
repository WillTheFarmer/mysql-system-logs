...
Monetary :moneybag: contributions made will encourage [Web Interface](https://github.com/WillTheFarmer/mysql-to-apache-echarts) repository development continuation for this MySQL or MariaDB schema populated by [log-files-to-mysql](https://github.com/willthefarmer/http-logs-to-mysql) repository.
